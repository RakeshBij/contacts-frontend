...
export const Contact = () => {
  const [nameCop, setNameCop] = useState(false);
  const [phoneCop, setPhoneCop] = useState(false);
  const [emailCop, setEmailCop] = useState(false);
  const url = new URL(window.location.href);
  const userId = url.pathname.split("/")[2];
  const data = url.search.split("&");
  const uName = data[0].split("=")[1];
  const uPhone = data[1].split("=")[1];
  const uEmail = data[2].split("=")[1];
  ...
  async function deleteHandler() {
    const { message, err } = await deleteContact(userId);
    if (message) {
  ...
  return (
    <>
      <div className="card-cont">
        <div className="contact-card" data-tilt data-tilt-glare>
          <div className="card-head">
            ...
            <div className="ch-ini">{uName[0]}</div>
          </div>
          <div className="card-body">
            <div className="card-name">
              ...
              <div className="copy-icon">
                ...
                {nameCop && <div className="done">Copied!</div>}
              </div>
            </div>
            <div className="card-num">
              ...
              <div className="copy-icon">
                <svg
                  ...
                  onClick={() => {
                    setPhoneCop(true);
                    navigator.clipboard.writeText(uPhone);
                  }}
                >
                  {/* <rect width="256" height="256" fill="none"></rect> */}
                  <polyline
                ...
                {phoneCop && <div className="done">Copied!</div>}
              </div>
            </div>
            {uEmail && (
              <div className="card-email">
                ...
                <div className="copy-icon">
                  <svg
                    ...
                    onClick={() => {
                      setEmailCop(true);
                      navigator.clipboard.writeText(uEmail);
                    }}
                  >
                    <rect width="256" height="256" fill="none"></rect>
                    <polyline
                  ...
                  {emailCop && <div className="done">Copied!</div>}
                </div>
              </div>
            )}
          </div>
